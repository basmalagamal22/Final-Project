...
;
const authService = {
    register: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/signup', data),
    login: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/signin', data),
    forgotPassword: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/forgotPasswords', data),
    verifyResetCode: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/verifyResetCode', data),
    resetPassword: (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/auth/resetPassword', data)
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
function LoginPage() {
    ...
    const { setWishlist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wishlistStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWishlistStore"])();
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            void Promise.allSettled([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cart$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cartService"].getCart().then((r)=>{
                    const d = r.data;
                    setCart(d.data._id, d.data.products, d.data.totalCartPrice, d.numOfCartItems, d.data.totalAfterDiscount);
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$wishlist$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wishlistService"].getWishlist().then((r)=>{
...
_s(LoginPage, "Us3nQnBLu+o2MiyRja8Qo6UjTnc=", false, function() {
    return [
...
//# sourceMappingURL=src_4f10ba6c._.js.map